...
def get_pie_chart(entered_site):
    ...
    if entered_site == 'ALL':
        ...
        filter_data=spacex_df[spacex_df['Launch Site']==entered_site]
        fig = px.pie(filter_data,  names='class', title='title')
        return fig
# TASK 4:
...
def get_scatter_chart(entered_site,slider):
    ...
    if entered_site == 'ALL':
        ...
        fig = px.scatter(x=spacex_df["Payload Mass (kg)"],y=spacex_df["class"],color=spacex_df["Booster Version"])
        ...
        fig = px.scatter(x=filter_data["Payload Mass (kg)"], 
                        y=filter_data["class"], 
                        color=filter_data["Booster Version"])
        return fig
# Run the app
